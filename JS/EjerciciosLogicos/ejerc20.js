//20) Programa una función que valide que un texto sea un email válido, pe. miFuncion("juanseabello2004@gmail.com") devolverá verdadero.
...
const validarEmail = (email = "") => {
    ...
    let expReg = /^(([^<>()\[\]\\.,;:\s@”]+(\.[^<>()\[\]\\.,;:\s@”]+)*)|(“.+”))@((\[[0–9]{1,3}\.[0–9]{1,3}\.[0–9]{1,3}\.[0–9]{1,3}])|(([a-zA-Z\-0–9]+\.)+[a-zA-Z]{2,}))$/i.test(email);
